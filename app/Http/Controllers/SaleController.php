...
class SaleController extends Controller
{
    ...
    public function cancelSale(Request $request, $saleId)
    {
        ...
        $sale->status = 'cancelled'; // Update the status
        $sale->cancel_description = $request->cancel_description; // Save the cancellation reason
        $sale->save();
    
        return redirect()->route('admin.sales.cancelled_details', $saleId)
            ->with('success', 'Sale cancelled successfully!');
    }
    
public function showCancelledSales()
{
    // Fetch all sales with the status 'Cancelled'
    $cancelledSales = Sale::where('status', 'Cancelled')->get();

    // Return the view with the cancelled sales data
    return view('admin.sales.cancelled_details', compact('cancelledSales'));
}
    ...
    public function showCancelDetails($saleId)
{
    ...
    public function listCancelledSales(Request $request)
    {
