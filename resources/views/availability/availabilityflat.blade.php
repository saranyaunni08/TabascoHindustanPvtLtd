    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <thead>
            ...
            <tr>
                ...
                <th style="border: 1px solid #000; text-align: center; padding: 8px; background-color: #d9d9d9;">DOOR NO</th>
                <th style="border: 1px solid #000; text-align: center; padding: 8px; background-color: #d9d9d9;">BUILT-UP AREA (In Sq Ft)</th>
                <th style="border: 1px solid #000; text-align: center; padding: 8px; background-color: #d9d9d9;">CARPET AREA (In Sq Ft)</th>
            </tr>
        </thead>
        <tbody>
