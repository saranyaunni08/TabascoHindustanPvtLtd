...
@endphp
                        <tr>
                            ...
                            <td>{{ $apartment['flat_build_up_area'] ?? 0 }}</td>
                            <td>{{ $apartment['flat_carpet_area'] ?? 0 }}</td>
                            ...
                            <td style="color: {{ $apartment['difference'] < 0 ? 'red' : 'green' }};">
                                ₹ {{ number_format($apartment['difference'], 2) }}
                            </td>

                            <td style="color: {{ $apartment['status'] == 'SOLD' ? 'green' : 'blue' }};">
                                {{ $apartment['status'] }}
                            </td>
                        </tr>
                        @php
